...
$query = "SELECT id_rol,id_usuario,datos_generales.id_datos_generales,datos_generales.nombre, datos_generales.apellido, usuario,password, datos_generales.fecha_nacimiento, datos_generales.genero FROM usuario INNER JOIN datos_generales ON usuario.id_datos_generales = datos_generales.id_datos_generales  WHERE usuario='$comp'";
